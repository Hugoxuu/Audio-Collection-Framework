...
# Setting up Configuration file paths
current_dir = os.path.dirname(__file__) or os.getcwd()
config_dir = os.path.join(current_dir, 'configurations')
...
setup(
    name="AWSDeepSenseSpokenDataCollectionFramework",
    version="1.0",
    ...
    # include data files
    data_files=[('configurations', ['configurations/aws_config'])],

    # declare your scripts
    # If you want to create any Python executables in bin/, define them here.
    # This is a three-step process:
    #
    # 1. Create the function you want to run on the CLI in src/aws_deep_sense_spoken_data_collection_framework/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/AWSDeepSenseSpokenDataCollectionFramework (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # AWSDeepSenseSpokenDataCollectionFramework = aws_deep_sense_spoken_data_collection_framework.cli:main
    # """,
    #
